...
//cria um tokem usando os dados de entrdada e a chave da variável de ambiente JWT_SECRET
export const generateToken = async (entrada:any) => jwt.sign(entrada, process.env.JWT_SECRET as string)

//verifica se o usuario possui autorização
export const authorization = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try{
        ...
        //o token não é valido, a resposta com HTTP Method 401 (unauthorized)
